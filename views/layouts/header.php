...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">'.Html::img('../img/icono.png', ['style'=>'width: 47px; height: 50px;']).'</span><span class="logo-lg">' . Html::img('../img/icono.png', ['style'=>'width: 47px; height: 50px; position: absolute; left: 20px;']).Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
