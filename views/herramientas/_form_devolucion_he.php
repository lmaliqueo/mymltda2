    ...
    <div class="box-header with-border">
        ...
        <span class="box-tools">
            <div class="form-group">
                <?= Html::submitButton('<i class="glyphicon glyphicon-save"></i> Guardar', ['class' => 'btn btn-default btn-flat bg-green', 'style'=>'border-width: 1px; border-color: green;']) ?>
            </div>
        </span>
    </div>
    <div class="box-body">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <?= $form->field($retorno_he, 'OT_ID')->widget(Select2::classname(), [
